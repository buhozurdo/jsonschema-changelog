...
from jsonschema_changelog.classifier import ChangeCategory, ChangeClassifier, ClassifiedChange, Severity
...
def sample_classification():
    ...
    changes = [
        ...
        SchemaChange(path="properties.email", change_type=ChangeType.ADDED, new_value={"type": "string"}),
...
class TestChangelogGenerator:
    ...
    def test_multi_version_changelog(self):
        ...
        generator = ChangelogGenerator()
        changelog = generator.generate_multi(results, dates=["2024-01-01", "2024-02-01"])
    ...
    def test_include_documentation_option(self, sample_classification):
        ...
        changes = sample_classification.changes[:]
        doc_change = ClassifiedChange(
            change=SchemaChange(path="root", change_type=ChangeType.DESCRIPTION_CHANGED),
...
class TestChangelog:
    ...
    def test_get_entry(self):
        ...
        entry = VersionEntry(version="1.0.0", previous_version="0.9.0", date="2024-01-01")
